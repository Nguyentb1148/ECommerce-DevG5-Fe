...
const CartItem = ({ item, variant, onUpdateQuantity, onRemove }) => {
  ...
  return (
    <div className="flex max-md:flex-col items-center md:justify-between p-4 mb-4 bg-gray-800 rounded-lg shadow-md">
      <div className="flex max-md:flex-col items-center space-x-4">
        <div className="max-md:w-full max-md:px-4 max-md:flex max-md:items-center max-md:justify-between ">
          <img
      ...
      <div className="max-md:hidden text-white font-semibold mt-2">
        <span>
          {new Intl.NumberFormat("vi-VN", {
            style: "currency",
            currency: "VND",
