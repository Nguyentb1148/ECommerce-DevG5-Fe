...
const AddVoucher = ({ onClose, onAddVoucher }) => {
 ...
 const validateForm = () => {
   ...
   if (!voucherData.createdAt) newErrors.createdAt = "Start date is required.";
   if (!voucherData.validity) newErrors.validity = "End date is required.";
   else if (new Date(voucherData.validity) <= new Date(voucherData.createdAt)) {
     newErrors.validity = "End date must be after start date.";
   }
 ...
 return (
     <div className="fixed inset-0 z-20 bg-black bg-opacity-50 flex items-center justify-center">
       <div className="bg-gray-800 rounded-lg shadow-md p-6 w-[500px]">
         ...
         {/* Code Voucher */}
         <div>
           <h3 className="text-base font-medium py-2 text-white">Code Voucher<span className="text-red-500 ml-1">*</span></h3>
           <input
               type="text"
               name="code"
         ...
         <div className="mb-2 flex justify-between">
           <div className="w-full pr-2">
             <h3 className="text-base font-medium py-2 text-white">Start date<span className="text-red-500 ml-1">*</span></h3>
             <input
                 type="date"
                 name="createdAt"
           ...
           <div className="w-full pl-2">
             <h3 className="text-lg font-medium py-2 text-white">End date<span className="text-red-500 ml-1">*</span></h3>
             <input
                 type="date"
                 name="validity"
         ...
         {/* Discount Value */}
         <div className="mb-4">
           <h3 className="text-base font-medium py-2 text-white">Discount Value(%)<span className="text-red-500 ml-1">*</span></h3>
           <input
               type="number"
               name="discount"
         ...
         {/* Description */}
         <div className="mb-4">
           <h3 className="text-base font-medium py-2 text-white">Description<span className="text-red-500 ml-1">*</span></h3>
           <input
               type="text"
               name="description"
