...
const EditVoucher = ({ onClose, onEditVoucher, selectedVoucher }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const updatedVoucherData = { ...voucherData, startDate: selectedVoucher.startDate };
          ...
          <div className="mb-2 flex justify-between">
            <div className="w-full pr-2">
              ...
              <input
                  type="date"
                  name="startDate"
                  value={voucherData.startDate?.split('T')[0] || ""} // Ensure createdAt is not editable
                  onChange={handleInputChange}
                  className="w-full border border-gray-600 bg-gray-700 text-white rounded p-2 mb-4"
                  required
              />
            ...
            <div className="w-full pl-2">
              ...
              <input
                  type="date"
                  name="endDate"
                  value={voucherData.endDate?.split('T')[0] || ""} // Handle endDate correctly, like createdAt
                  onChange={handleInputChange}
                  className="w-full border border-gray-600 bg-gray-700 text-white rounded p-2 mb-4"
                  required
              />
