...
const ConfirmInfoPayment = ({
  ...
  const handleCityChange = async (event) => {
    ...
    try {
      const selectedDistrictData = await import(`../../data/quan-huyen/${selectedCityCode}.json`);
...
// Handle district selection and load corresponding ward data
  const handleDistrictChange = async (event) => {
    ...
    try {
      const selectedWardData = await import(`../../data/xa-phuong/${selectedDistrictCode}.json`);
      setWard(selectedWardData.default);
    } catch (e) {
      console.error("Error loading ward data for district:", selectedDistrictCode);
      setWard([]);
    }
  };
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'ward') {
      ...
      setFormData((prev) => {
        ...
        const combinedAddress = `${updatedFormData.address}, ${updatedFormData.ward?.name_with_type || ''}, ${updatedFormData.district?.name_with_type || ''}, ${updatedFormData.city?.name_with_type || ''}`;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                    ...
                    className={`mt-1 block w-full px-4 py-2 bg-gray-700 text-white border ${errors.fullName ? "border-red-500" : "border-gray-600"} rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500`}
              ...
              <div>
                ...
                <select
                    ...
                    className={`mt-1 block w-full px-4 py-2 bg-gray-700 text-white border ${errors.city ? "border-red-500" : "border-gray-600"} rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500`}
                >
              ...
              <div>
                ...
                <select
                    ...
                    className={`mt-1 block w-full px-4 py-2 bg-gray-700 text-white border ${errors.district ? "border-red-500" : "border-gray-600"} rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500`}
                >
              ...
              <div>
                <label htmlFor="ward" className="block text-sm font-medium text-gray-400">
                  Ward
                </label>
                <select
                    id="ward"
                    ...
                    onChange={handleInputChange}
                    className={`mt-1 block w-full px-4 py-2 bg-gray-700 text-white border ${errors.ward ? "border-red-500" : "border-gray-600"} rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500`}
                >
              ...
              <div className="md:col-span-2">
                ...
                <input
                    ...
                    onChange={handleInputChange}
                    className={`mt-1 block w-full px-4 py-2 bg-gray-700 text-white border ${errors.address ? "border-red-500" : "border-gray-600"} rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500`}
