...
const ListProduct = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setProductsData(productData.data); // Set to empty array if data is invalid
      } catch (error) {
        console.error("Failed to fetch products:", error);
        setProductsData([]); // Set to empty array in case of failure
      }
    };
  ...
  // Only perform slice if productsData is an array
