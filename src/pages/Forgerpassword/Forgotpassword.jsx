...
const ForgotPassword = () => {
    ...
    const [showSuccess, setShowSuccess] = useState(false);  // Success flag for the green tick
    const [formVisible, setFormVisible] = useState(true); // To control form visibility after success
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg border border-gray-300">
                ...
                {showSuccess && (
                    <div className="flex items-center justify-center text-green-500 text-6xl mb-4 animate-pulse">
                        <FcCheckmark className="w-24 h-24 mr-2" />  {/* Using the checkmark icon with animation */}
                    </div>
                )}
